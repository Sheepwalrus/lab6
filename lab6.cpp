...

{
  ...
  book(bookStatus tempstatus, double tempnumofPages, double tempwidth,
       double templength, string temptitle) {
...
class lamp {
  ...
  lamp(string tempcolor, double tempwidth, double templength,
       lampStatus tempstatus) {
...
public:
  ...
  table(string tempColor, int tempNumLegs, double tempLength, double tempWidth,
        material tempMake) {
    color = tempColor;
    numLegs = tempNumLegs;
    length = tempLength;
